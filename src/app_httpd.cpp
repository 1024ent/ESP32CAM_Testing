...
#if CONFIG_LED_ILLUMINATOR_ENABLED
  int ledChannel = 0; // Choose a PWM channel (0-15 on ESP32)
  int freq = 5000;    // Frequency in Hz
  int resolution = 8; // Resolution in bits (0-255 for 8-bit)

  // Attach the pin to the LEDC channel
  ledcAttachPin(pin, ledChannel);

  // Set up the LEDC channel with the desired frequency and resolution
